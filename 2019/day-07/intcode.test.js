...
test('Day 07 Part 1 run(TEST 1)', () => {
  ...
  // 4,3,2,1,0
  let outputA = parseInt(intcode.run(_memory, [4,0]));
  let outputB = parseInt(intcode.run(_memory, [3,outputA]));
  let outputC = parseInt(intcode.run(_memory, [2,outputB]));
  let outputD = parseInt(intcode.run(_memory, [1,outputC]));
  let outputE = parseInt(intcode.run(_memory, [0,outputD]));
...
test('Day 07 Part 1 run(TEST 2)', () => {
  ...
  // 0,1,2,3,4
  let outputA = parseInt(intcode.run(_memory, [0,0]));
  let outputB = parseInt(intcode.run(null, [1,outputA]));
  let outputC = parseInt(intcode.run(null, [2,outputB]));
  let outputD = parseInt(intcode.run(null, [3,outputC]));
  let outputE = parseInt(intcode.run(null, [4,outputD]));
...
test('Day 07 Part 1 run(TEST 3)', () => {
  ...
  // 1,0,4,3,2
  let outputA = parseInt(intcode.run(_memory, [1,0]));
  let outputB = parseInt(intcode.run(_memory, [0,outputA]));
  let outputC = parseInt(intcode.run(_memory, [4,outputB]));
  let outputD = parseInt(intcode.run(_memory, [3,outputC]));
  let outputE = parseInt(intcode.run(_memory, [2,outputD]));
